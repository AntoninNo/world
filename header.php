    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link active" href="index2.php?">Home <span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item">
        ...
        <?php endforeach ; ?>
        <li class="nav-item active">
          <a class="nav-link" href="mapWorld.php">Carte du Monde <span class="sr-only">(current)</span></a>
        </li>
          </div>
        </li>
      </ul>
